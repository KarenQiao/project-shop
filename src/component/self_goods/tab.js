...
var bottomBtn={
    ...
    showBar:function () {
        ...
        document.getElementsByClassName('hot_table_bar')[0].addEventListener('click',function () {

            if (document.getElementsByClassName('hide_left_table')[0].className.indexOf('show_table_bar') > -1) {
                ...
                document.getElementsByClassName('hide_left_table')[0].className = 'hide_left_table show_table_bar';
        ...
        document.getElementsByClassName('all_table_bar')[0].addEventListener('click',function () {

            if (document.getElementsByClassName('hide_right_table')[0].className.indexOf('show_table_bar') > -1) {
                ...
                document.getElementsByClassName('hide_right_table')[0].className = 'hide_right_table show_table_bar';
